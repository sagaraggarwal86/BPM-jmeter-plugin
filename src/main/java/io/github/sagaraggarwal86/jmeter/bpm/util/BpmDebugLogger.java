...
public final class BpmDebugLogger {
     ...
     *
     * @param samplerLabel    display label of the sampler
     * @param score           computed performance score (0-100), nullable when SPA-stale
     * @param improvementArea primary improvement area label (e.g. {@link BpmConstants#BOTTLENECK_CLIENT})
     */
    public void logDerivedMetrics(String samplerLabel, Integer score, String improvementArea) {
        if (!enabled) {
            return;
        }
